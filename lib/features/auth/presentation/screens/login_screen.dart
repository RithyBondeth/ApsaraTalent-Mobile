              ...
              Column(
                ...
                children: [
                  ...
                  _buildPhoneNumberButton(
                    ...
                    onClick: () {
                      context.router
                          .pushPath(RoutePathConstant.phoneNumberLoginPath);
                    },
                  ),
                  SizedBox(height: 10),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              context.router.pushPath(RoutePathConstant.forgotPasswordPath);
            },
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              context.router.pushPath(RoutePathConstant.resetPasswordPath);
            },
